...
I want to carry out a report on the top N populated capital cities in a continent where N is provided by the user so that the organisation can comprehend and have access to the top N populated cities a continent
...
1. Organisation requests data listing on the top N populated capital cities in a continent where N is provided by the user
