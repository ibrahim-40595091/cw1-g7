...
I want to achieve a report on all the capital cities in the world organised by largest population to the smallest so that the organisation can gain insight on how population is distributed in capital cities in the world.
...
1. Organisation requests data listing on all the capital cities in the world organised by largest population to the smallest.
