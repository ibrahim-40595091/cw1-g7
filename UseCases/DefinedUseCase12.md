...
I want to formulate a report on the top N populated cities in the world where N is provided by the user so that I can ensure the reporting of N populated cities for the organisation.
...
1. Organisation requests data listing on the top N populated cities in the world where N is provided by the user
