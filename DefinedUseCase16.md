...
I want to formulate a report on the top N populated cities in a country where N is provided by the user so that I can ensure the organisation is kept up to date on the top N cities in a country.
...
1. Organisation requests data listing on the top N populated cities in a country where N is provided by the user.
